...
class Page {
	...
	public function header($title = null) {
		...
		"	<script type='text/javascript' src='js/jquery.sumValues.js'></script>\n".
		"</head>\n\n".
	...
	public function footer()
	{
		...
		$end = microtime(true);
		printf('<p>Copyright &copy; 2011 Ryan Holmes, aka Sable Blitzmann | gitRev: %s | Database dump: '.DBVERSION.' | %01.002fms (%0.5fs)</p>', `git describe --tags`, ($end - START) * 1000, $end - START);
		echo "</div>\n\n</body>\n</html>";
